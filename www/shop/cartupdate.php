...
$send_gift = (isset($_REQUEST['send_gift']) && $_REQUEST['send_gift']) ? 1 : 0;
...
if($send_gift ==1){
  if ($is_member)
  {
    goto_url(G5_SHOP_URL."/orderform_gift.php?sw_direct=$sw_direct");
  }
  else
  {
    goto_url(G5_BBS_URL."/login.php?url=".urlencode(G5_SHOP_URL."/orderform_gift.php?sw_direct=$sw_direct"));
  }
